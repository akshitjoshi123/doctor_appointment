...
from doctors.views import InviteDoctorView, DoctorRegistration, DoctorList, PatientsAppointmentList, ActionAppointmentList, UpdateDoctorProfileView, ReScheduleAppointmentList
